            ...
            <div class="col-lg-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" role="form" method="POST" action="{{ route('tag::store') }}">
                            {{ csrf_field() }}
                            <fieldset>
                                @include('tag._form')
                          ...
                          <tbody>
                            @foreach($tag as $data)
                              <tr>
                                  ...
                                  <td>
                                    <div class="actionBar">
                                        <a href="{{route('tag::edit',['id'=>$data->id])}}"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"/></svg></a>
